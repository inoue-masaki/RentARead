module UserAuth
  ...
  module TokenCommons
    ...
    #以下３つのメソッドは暗号化したuser_idをJWTのペイロードに埋め込むために使う
    
      # JWTに入れたユーザーIDを隠すためのメソッド
      def crypt
        salt = "signed user id"
      ...
      # user_id暗号化
      # encrypt_forを使うと毎度違うkajfekajに暗号化されるので解読されにくい
